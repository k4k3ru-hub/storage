...
//
// NewUsageBalanceStore creates a usage balance store.
//
// Version:
//   - 2026-07-26: Added.
//
func NewUsageBalanceStore(tableName string) (*UsageBalanceStore, error) {
	operationErr := "failed to create account app usage balance store"
...
//
// ValidateUsageBalanceAccountID validates a usage balance account ID.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// ValidateAccountID validates the usage balance account ID.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// ValidateUsageBalanceStatus validates a usage balance status.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// ValidateStatus validates the usage balance status.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// ValidateUsageBalanceMetaData validates usage balance metadata.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// ValidateMetaData validates the usage balance metadata.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// CreateTable creates the usage balance table.
//
// Version:
//   - 2026-07-26: Added.
//
func (s *UsageBalanceStore) CreateTable(ctx context.Context, executor k4k3ruAPI.Executor) error {
	operationErr := "failed to create usage balance table"

	// Guard.
	if s == nil {
		return fmt.Errorf("%s: invalid parameter: usage_balance_store=null", operationErr)
	}
	if s.tableName == "" {
...
//
// DeleteByAccountID deletes a usage balance by account ID.
//
// Parameters:
...
// Version:
//   - 2026-07-27: Added.
//   - 2026-08-06: Changed the target column from ID to account ID.
//
func (s *UsageBalanceStore) DeleteByAccountID(ctx context.Context, executor k4k3ruAPI.Executor, accountID uint64) error {
	operationErr := "failed to delete usage balance by account id"
...
//
// DeleteByID deletes a usage balance using its account ID.
//
// Parameters:
//   - ctx: Context for the operation.
//   - executor: SQL executor.
...
func (s *UsageBalanceStore) Insert(ctx context.Context, executor k4k3ruAPI.Executor, params *UsageBalanceInsertParams) error {
	...
	if params == nil {
		return fmt.Errorf("%s: invalid parameter: usage_balance_insert_params=null", operationErr)
	}
...
//
// SelectByAccountID selects a usage balance by account ID.
//
// Version:
//   - 2026-07-27: Added.
//
func (s *UsageBalanceStore) SelectByAccountID(ctx context.Context, executor k4k3ruAPI.Executor, accountID uint64) (*UsageBalance, error) {
	operationErr := "failed to select usage balance by account id"

	// Guard.
	if s == nil {
		return nil, fmt.Errorf("%s: invalid parameter: usage_balance_store=null", operationErr)
	}
	if s.tableName == "" {
...
//
// SelectForUpdateByAccountID selects a usage balance for update by account ID.
//
// Version:
//   - 2026-07-27: Added.
//
func (s *UsageBalanceStore) SelectForUpdateByAccountID(ctx context.Context, tx *sql.Tx, accountID uint64) (*UsageBalance, error) {
	operationErr := "failed to select usage balance for update by account id"
...
//
// UpdateByAccountID updates a usage balance by account ID.
//
// Version:
//   - 2026-07-27: Added.
//
func (s *UsageBalanceStore) UpdateByAccountID(ctx context.Context, executor k4k3ruAPI.Executor, params UsageBalanceUpdateParams, accountID uint64) error {
	operationErr := "failed to update usage balance by account id"
	...
	if accountID == 0 {
		return fmt.Errorf("%s: invalid parameter: account_id=0", operationErr)
	}
...
//
// IsValid reports whether the usage balance status is valid.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// Validate validates the usage balance status.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// Value returns the usage balance status as a driver.Value.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// Scan scans a usage balance status.
//
// Version:
//   - 2026-07-26: Added.
//
...
//
// Validate validates usage balance insert parameters.
//
// Version:
//   - 2026-07-27: Added.
//
...
//
// BuildQuery builds a SELECT query.
//
// Version:
//   - 2025-07-27: Added.
//
func (p UsageBalanceSelectParams) BuildQuery(selectFromClause string) (string, []any) {
	...
	switch p.OrderBy {
	case ColAccountID, ColStatus, ColBalanceTicks, ColMetaData, ColCreatedAt, ColUpdatedAt:
...
//
// Validate validates usage balance update parameters.
//
// Version:
//   - 2026-07-27: Added.
//
